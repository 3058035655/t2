...
class TestNewbkb(unittest.TestCase):
    def test_newbkb(self):
        ...
        title="m爆款标201822802"
        driver.find_element_by_id("loanTitle").send_keys(title)
        handles=driver.current_window_handle
        print(handles)
        driver.find_element_by_id("loanBorrowershowname").send_keys(title)
        driver.find_element_by_id("projectCode").send_keys(title)
