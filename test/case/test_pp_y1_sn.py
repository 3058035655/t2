            ...
            with self.subTest (data=d):
                ...
                for u in tzusers:
                    with self.subTest (tzuser=u):
                        ...
                        t=driver.find_element_by_xpath("html/body/div[2]/div[2]/div[2]/div[2]/div[1]/span").text
                        # string转换为float类型
                        ...
                        for d in datas:
                            with self.subTest (data=d):
                                ...
                                time.sleep(2)
                                    ...
                                    # driver.find_element_by_name ("title").send_keys (youxuan2)
                                    # time.sleep (2)
                                    # driver.find_element_by_link_text ("查询").click ()
                                    # driver.find_element_by_link_text ("审核").click ()
                                    # time.sleep (1)
                                ...
                                driver.find_element_by_link_text ("一个优选匹配多个散标").click ()
                                driver.switch_to_frame ("contentIframe")
                                driver.find_element_by_name ("title").send_keys (cell_value)
                                driver.find_element_by_link_text ("查询").click ()
                                ...
                                driver.find_element_by_name ("title").send_keys ("m散标201803190")
                                driver.find_element_by_link_text ("查询").click ()
                                time.sleep(2)
                                # # 选择一个
                                # driver.find_element_by_name ("checks").click ()
                                # 选择多个
