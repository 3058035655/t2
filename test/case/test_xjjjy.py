...
class TestNewjjy(unittest.TestCase):
    excel = DATA_PATH + '/jijiying.xlsx'
    def test_newjjy(self):
        ...
        for d in datas:
            with self.subTest (data=d):
                ...
                driver.find_element_by_id("li1_input_68794eb3-c85f-11e4-90b2-d89d67270c78_3").click()
                ...
                driver.find_element_by_id("amount").send_keys("30000")
                # 月数
