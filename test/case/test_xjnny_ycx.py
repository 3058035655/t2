...
class TestNewnnyycx(unittest.TestCase):
    excel = DATA_PATH + '/YCXniannianying.xlsx'
    def test_newtnny_ycx(self):
        ...
        for d in datas:
            with self.subTest (data=d):
                ...
                driver.find_element_by_id("li1_input_c03159c5-0f78-11e7-8183-141877633774_4").click()
