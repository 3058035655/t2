...
class TestNewtyb(unittest.TestCase):
    excel = DATA_PATH + '/tiyanbiao.xlsx'
    def test_newtyb(self):
        ...
        for d in datas:
            with self.subTest (data=d):
                ...
                driver.find_element_by_id("li1_input_b0006936-39e8-11e5-9ecc-1051721c3a3e_5").click()
                ...
                driver.find_element_by_xpath(".//*[@id='loginName']").send_keys("张效伟")
