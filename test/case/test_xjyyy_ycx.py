...
class TestNewyyyycx(unittest.TestCase):
    excel = DATA_PATH + '/YCXyueyueying.xlsx'
    def test_newtyyy_ycx(self):
        ...
        for d in datas:
            with self.subTest (data=d):
                ...
                driver.find_element_by_id("li1_input_242618f5-0f78-11e7-8183-141877633774_2").click()
